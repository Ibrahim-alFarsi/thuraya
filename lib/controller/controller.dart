...
import 'package:thuraya_app/model/plant_sub_types_model.dart';
import 'package:thuraya_app/model/popular_plant.dart';

class OnboardingScreenController extends GetxController {
  int currentPage = 0;

  void onPageChange(int initialPage) {
...
class PopularPlantDataScreen extends GetxController {
  ...
  void onLikePosition(PopularPlant e) {
  ...
  void onSetDetail(PopularPlant e) {
...
class FilterSheetController extends GetxController {
  ...
  void onChageOptionValue(int index) {
    option = index;
    update();
  }
}
...
class PlantDetailScreenController extends GetxController {
  ...
  void onBackposition(bool pos) {
    position = pos;
    update();
  }

  void onSetCheakPosition(int value) {
    cheakPosition = value;
    update();
  }
...
class SubtypesOfPlantScreenController extends GetxController {
  void onLikePosition(PlantSubtype subType) {
...
class PaymentMethodScreenController extends GetxController {
  ...
  void onClickPaymentRadioButton(String value) {
    // ignore: avoid_print
    print(value);
    select = value;
    update();
...
class CartController extends GetxController {
  ...
  void addAddress(String country, String street, String city, String pincode,
      String phoneNumber) {
