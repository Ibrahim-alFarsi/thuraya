...
import 'package:thuraya_app/view/home/profile_screens/my_profile_screen.dart';
import 'package:thuraya_app/view/home/profile_screens/setting_screen.dart';
                ...
                children: [
                  Container(
                    ...
                    child: getAppBar("Profile",
                        iconpermmition: false, space: 131.w),
                  ),
                  getVerSpace(20.h),
                  Container(
                    color: regularWhite,
                        ...
                        GetBuilder<MyOrderScreenController>(
                          ...
                          builder: (myOrderScreenController) =>
                              getProfileOption("myOrderIcon.svg", "My Orders",
                                  () {
                            myOrderScreenController.onMyorderBackposition(true);
                            Get.to(MyOrders());
                          }),
                        ),
                        getDivider(),
